...
<div class="filter-card">
    ...
    <div class="filter-body">
        <form method="GET" action="{{ route('admin.reports.index') }}" id="filterForm">
            ...
            {{-- Payment Mode Filter --}}
            <div style="margin-top:20px;padding-top:16px;border-top:1px solid #e3e6e8;">
...
<div style="background:#fff;border-radius:8px;padding:16px 24px;border:1px solid #e3e6e8;border-left:4px solid #f59e0b;margin-bottom:16px;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px;">
    <div>
