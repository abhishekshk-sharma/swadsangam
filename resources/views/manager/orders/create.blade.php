...
<div style="margin-bottom:16px;">
    <a href="{{ route('manager.orders.index') }}" style="color:#2563eb;font-weight:600;font-size:14px;text-decoration:none;">← Back to Orders</a>
</div>
    ...
    <div style="position:sticky;top:0;background:#f9fafb;padding-bottom:12px;z-index:10;">
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:12px;">
            ...
            <button onclick="viewCart()" style="background:none;border:none;cursor:pointer;position:relative;font-size:24px;">
                🛒<span id="cartBadge" style="display:none;position:absolute;top:-8px;right:-8px;background:#ef4444;color:#fff;font-size:11px;border-radius:50%;width:18px;height:18px;align-items:center;justify-content:center;font-weight:700;">0</span>
            </button>
        </div>
...
<div id="cartModal" style="display:none;position:fixed;inset:0;background:rgba(0,0,0,0.5);z-index:9999;align-items:flex-end;">
...
function submitOrder() {
    ...
    form.method = 'POST'; form.action = '{{ route('manager.orders.store') }}';
