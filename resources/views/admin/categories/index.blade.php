...
<div class="max-w-4xl">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold">Table Categories</h1>
        <a href="{{ route('admin.tables.index') }}" class="bg-gray-500 text-white px-4 py-2 rounded hover:bg-gray-600">Back to Tables</a>
    </div>
    ...
    <div class="bg-white p-6 rounded-lg shadow mb-6">
        ...
        <form action="{{ route('admin.categories.store') }}" method="POST" class="flex gap-4">
            @csrf
            <input type="text" name="name" placeholder="Category Name (e.g., AC, Non-AC)" class="flex-1 border rounded px-3 py-2" required>
        ...
        <table class="w-full">
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4">{{ $category->tables_count }}</td>
                    <td class="px-6 py-4">
