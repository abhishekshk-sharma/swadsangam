...
<div class="d-flex justify-between align-center mb-4">
    <h2 style="font-size:1.2rem;font-weight:600;color:var(--gray-800);">Edit — {{ $employee->name }}</h2>
    <a href="{{ route('admin.staff.index') }}" class="btn btn-secondary btn-sm"><i class="fas fa-arrow-left"></i> Back</a>
</div>
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;">
                ...
                <div class="form-group" style="display:flex;align-items:flex-end;padding-bottom:0.25rem;">
                    <label style="display:flex;align-items:center;gap:0.5rem;cursor:pointer;font-size:0.9rem;">
                        <input type="checkbox" name="is_active" value="1" {{ old('is_active', $employee->is_active) ? 'checked' : '' }} style="width:16px;height:16px;accent-color:var(--blue-600);"> Active
                    </label>
                </div>
                <div class="form-group">
