...
@section('header', 'Manage Menu Categories')
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <table class="w-full">
                    <thead>
                        <tr class="text-left text-gray-600 text-sm">
                            ...
                            <th class="pb-3">Menu Items Count</th>
                    ...
                    <tbody>
                        ...
                        <tr class="border-t">
                            ...
                            <td class="py-3">{{ $category->menu_items_count }}</td>
                            <td class="py-3">
                                <form action="/superadmin/menu-categories/{{ $category->id }}" method="POST" onsubmit="return confirm('Delete this category?')">
                                    @csrf
                                    @method('DELETE')
    ...
    <div>
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <form action="/superadmin/menu-categories" method="POST">
                @csrf
                <div class="mb-4">
