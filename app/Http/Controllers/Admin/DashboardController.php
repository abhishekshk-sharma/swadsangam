...
use App\Models\{RestaurantTable, MenuItem, Order, User};
...
class DashboardController extends Controller
{
    public function index()
    {
        $stats = [
            ...
            'employees' => User::where('tenant_id', session('tenant_id'))->count(),
        ];
        ...
        $recentEmployees = User::where('tenant_id', session('tenant_id'))->latest()->take(5)->get();
