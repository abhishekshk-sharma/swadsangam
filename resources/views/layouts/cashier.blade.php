    ...
    <div class="flex flex-col h-screen">
        ...
        <div class="bg-blue-900 text-white p-4 shadow-lg">
            ...
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-xs text-blue-300">{{ current_user()->name ?? 'User' }} - Cashier
        ...
        <div class="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-lg">
            <div class="flex justify-around">
                <a href="{{ route('cashier.dashboard') }}" class="flex-1 text-center py-3 {{ request()->routeIs('cashier.dashboard') ? 'text-blue-600 bg-blue-50' : 'text-gray-600' }}">
                    <div class="text-2xl">■</div>
                    <div class="text-xs">Dashboard</div>
                </a>
                <a href="{{ route('cashier.payments.index') }}" class="flex-1 text-center py-3 {{ request()->routeIs('cashier.payments.index') ? 'text-blue-600 bg-blue-50' : 'text-gray-600' }}">
                    <div class="text-2xl">₹</div>
